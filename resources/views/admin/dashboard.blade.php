...
@section('layout')
    <div class="flex flex-col">
        <div class="flex justify-end">
            <div class="flex items-center justify-end gap-2 h-16 w-full bg-white-color">
                <img src="{{ asset('assets/dashboard/brand.svg') }}" alt="Default avatar" class="w-9 h-9 rounded">
                <p class="text-lg font-bold">belly nakal</p>
            </div>
        </div>
