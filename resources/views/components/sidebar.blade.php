        ...
        <ul class="space-y-4 font-medium">
            ...
            <li>
                <a href='/admin/history'
                    class="flex items-center px-6 py-3 {{ request()->is('admin/history') ? 'text-white bg-blue-700' : 'text-gray-700 hover:text-white' }} rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group-hover:text-gray-900">
                    {{-- svg --}}
